<?php
    ...
    <?php } ?>
    <!-- Customer Section-->
    <?php if(isset($autolpSettings['section_2']) && ($prevData['worried_heading'] || $prevData['worried_sub_heading'] || $prevData['group-customer'] )){
        if($prevData['worried_heading'] || $prevData['worried_sub_heading'] || $customer['customer_images'] || $customer['customer_description'] ) { ?>
    ...
    <?php if(isset($autolpSettings['section_4']) && ($prevData['why_insta_heading'] || $prevData['why_insta_sub_heading'] || $prevData['group-insta'])){ 
      if($prevData['why_insta_heading'] || $prevData['why_insta_sub_heading'] || $insta['add_insta_heading'] || $insta['add_insta_description']  ){ ?>
          ...
          <div class="container-fluid">
            <div class="form-row">
              <?php foreach($prevData['group-insta'] as $insta){ 
                 ...
                 if(!empty($insta['add_insta_heading']) || !empty($insta['add_insta_description'] )){
                  ?> 
    ...
    <?php if(isset($autolpSettings['section_6']) && ($prevData['why_surviral_heading'] || $prevData['why_surviral_description'] || $prevData['group-why-surviral'] )){ 
      if($prevData['why_surviral_heading'] || $prevData['why_surviral_description'] || $why_surviral['why_surviral_repater_images'] || $why_surviral['why_surviral_repater_heading'] || $why_surviral['why_surviral_repater_description']) {?>
    ...
    <?php if(isset($autolpSettings['section_7']) && ( $prevData['step_heading'] || $prevData['step_description'] || $prevData['group-three-steps'] )){ ?>
        <!-- Carousel Section Start -->
        <?php  if( $prevData['step_heading'] || $prevData['step_description']  ){ ?>
      <section id="section_7" class="section-carousel three-carousel bg-light-pink common-section pt_80 pb_80 section-7">
        <div class="container-fluid">
          ...
          if(!empty($prevData['group-three-steps'])){ 
            // Added slider after ?>
          <div class="carousel-ui text-left pt_5">
              <div class="slider slickThreeItems">
                <?php foreach($prevData['group-three-steps'] as $three_step ){
                  if(!empty($three_step['steps_repeater_heading']) || !empty($three_step['steps_repeater_description'])){
                    ?> 
                  <div class="img-card text-center w_250 max_w_100p px_5">
                    <!--Image Upload -->
    ...
    <?php 
    if(isset($autolpSettings['section_8']) ){ 
            ...
            ?>
    <?php } ?>
    <?php if(isset($autolpSettings['section_9']) && ( $prevData['ai_heading'] || $prevData['ai_description'] || $prevData['group-ai-repeater'] )){  
      if($prevData['ai_heading'] || $prevData['ai_description'] || $ai_repeater['ai_repeater_text'] || $ai_repeater['ai_upload_icons']) { ?>
      ...
      <section id="section_9" class="section-cardicons common-section bg-white pt_70 pb_40 section-9">
        ...
        <?php if(!empty($prevData['group-ai-repeater'])){ ?>
        <div class="container-fluid">
          <div class="form-row">
              <?php foreach($prevData['group-ai-repeater'] as $ai_repeater){ 
                 if(!empty($ai_repeater['ai_repeater_text'])){
                  ?>
                  <div class="col-3">
                      <div class="card r_0 border-0 text-center mb_30">
    ...
    <?php if(isset($autolpSettings['section_10']) && ( $prevData['automated_heading'] || $prevData['description'] || $prevData['group-automated-surviral'] )){ 
      if($prevData['automated_heading'] || $prevData['list_function_desc'] || $automated_surviral['automated_text'] || $automated_surviral['automated_description']) { ?>
      <section id="section_10" class="section-cardicons common-section bg-light-pink pt_70 pb_50 section-10">
        <div class="container">
          ...
          <?php } 
          if($prevData['list_function_desc']){
          ?>
          <p class="section-description text-center mb_60"><?php echo $prevData['list_function_desc']; ?></p>
          <?php } ?>
        </div>
        <?php 
        if(!empty($prevData['group-automated-surviral'])){ 
        ?>
          <div class="container">
            <div class="form-row">
              <?php foreach($prevData['group-automated-surviral'] as $automated_surviral){
                if(!empty($automated_surviral['automated_text']) || !empty($automated_surviral['automated_description'])){
                ?>
                <div class="col-4">
    ...
    <?php if(isset($autolpSettings['section_11']) && ( $prevData['faq_heading'] || $prevData['group-faq-left'] || $prevData['group-faq-right'] )){  
      if($prevData['faq_heading'] || $faq_left['faq_left_repeater_heading'] || $faq_left['faq_left_repeater_description'] ||  $faq_right['faq_right_repeater_heading'] || $faq_right['faq_right_repeater_description']) { ?>
      ...
      <section id="section_11" class="section-accordion common-section bg-white pt_80 pb_80 section-11">
        ...
        <?php if($prevData['faq_heading']){?>
          ...
          <?php }  ?>
          <?php if($prevData['faq_description']){?>
            <p class="section-description text-center mb_60"><?php echo $prevData['faq_description']; ?></p>
          <?php }  ?>
          <?php
          if($prevData['group-faq-left']){
          ?>
            <div class="row">
                  ...
                  <div class="accordion_design1 ">
                    <div class="accordion" id="accordionExample">
                      ...
                      foreach($prevData['group-faq-left'] as $faq_left){ 
                        if(!empty($faq_left['faq_left_repeater_heading']) && !empty($faq_left['faq_left_repeater_description'])){ 
                        ?>
                          <div class="card">
                            <div class="card-header" id="heading<?php echo $left_counter; ?>">
                              <h2 class="mb-0 <?php if ($left_counter > 50) { echo "collapsed"; } ?>" data-toggle="collapse" data-target="#collapse<?php echo $left_counter; ?>" aria-expanded="true" aria-controls="collapse<?php echo $left_counter; ?>"><i class="fas fa-chevron-down mr_10"></i><i class="fas fa-minus mr_10"></i><?php echo $faq_left['faq_left_repeater_heading']; ?></h2>
                            </div>

                            <div id="collapse<?php echo $left_counter; ?>" class="collapse <?php echo ($left_counter == 50) ? 'show' : ''; ?>" aria-labelledby="heading<?php echo $left_counter; ?>" data-parent="#accordionExample">
              ...
              <div class="col-12 col-sm-6">
                    ...
                    <?php 
                      ...
                      foreach($prevData['group-faq-right'] as $faq_right){ 
                        if(!empty($faq_right['faq_right_repeater_heading']) && !empty($faq_right['faq_right_repeater_description'])){ 
                        ?>
                        <div class="card">
                            <div class="card-header" id="heading<?php echo $right_counter; ?>">
                              <h2 class="mb-0 <?php if ($right_counter > 1) { echo "collapsed"; } ?>" data-toggle="collapse" data-target="#collapse<?php echo $right_counter; ?>" aria-expanded="true" aria-controls="collapse<?php echo $right_counter; ?>"><i class="fas fa-chevron-down mr_10"></i><i class="fas fa-minus mr_10"></i><?php echo $faq_right['faq_right_repeater_heading']; ?></h2>
                            </div>
                            <div id="collapse<?php echo $right_counter; ?>" class="collapse <?php echo ($right_counter == 1) ? 'show' : ''; ?>" aria-labelledby="heading<?php echo $right_counter; ?>" data-parent="#accordionExample2">
    ...
    //if(isset($autolpSettings['section_12'])){  ?>
    <?php
...
<?php if($prevData['register_now_third_previous_section'] || $prevData['register_now_heading'] || $prevData['register_now_button_link'] || $prevData['register_now_icons'] || $prevData['register_now_button_label'] || $prevData['register_now_third_section_heading'] || $prevData['register_now_third_section_button_label'] || $prevData['goole_map'] || $prevData['footer_images'] || $prevData['footer_address'] || $prevData['footer_address_title'] || $prevData['group-footer-site-map'] || $prevData['footer_site_map_title'] || $site_map['site_map_page_link'] || $site_map['site_map_page_title'] || $prevData['footer_copy_right'] ){ ?>
      ...
      <div class="container-fluid">
          <div class="overlay_b position-relative pt_25">
            <div class="container pb_60">
              <div class="form-row">
                <div class="col-12 col-xs-12 col-sm-6 col-md-1 d-lg-flex foot_sec1"></div>
                <!-- Google Iframe start -->
